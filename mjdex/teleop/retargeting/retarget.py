"""Unified retargeting interface for MjDex hand teleoperation.
...
Usage:
    retargeter = Retargeter.from_yaml("mjdex/assets/sharpa_wave/avp_sharpa_hand.yaml", hand_side="right")
