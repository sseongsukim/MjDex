...
def get_exp_name(agent_name, seed):
    """Return the experiment name."""
    exp_name = f"{agent_name}_"
...
def get_wandb_group(run_group, env_name, agent_name, group_format=None):
    """Return a wandb group name from run metadata."""
    if group_format is None:
        group_format = "{run_group}/{env_name}/{agent_name}"
